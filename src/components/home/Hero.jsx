...
const HeroSection = () => {
  return (
    <div className="w-full h-[649px] bg-[url('/images/plane.jpg')] bg-no-repeat bg-cover rounded-3xl flex flex-col items-center justify-center gap-y-8">
      {/* Heading Section */}
     ...
     <Link to={"/services"}>
     <div className=" flex items-center gap-2 px-4 py-3 md:px-5 md:py-4 rounded-lg border border-white cursor-pointer">
